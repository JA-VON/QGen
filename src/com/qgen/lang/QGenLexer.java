...
public class QGenLexer implements java_cup.runtime.Scanner {
	...
	public QGenLexer (java.io.Reader reader) {
		this ();
		if (null == reader) {
	...
	public QGenLexer (java.io.InputStream instream) {
		this ();
		if (null == instream) {
			throw (new Error("Error: Bad input stream initializer."));
		}
...
"29:8,5:2,4,29,5,4,29:18,5,29:3,26,29:3,9,10,29,30,29:4,28:10,6,29:2,30,29,3" +
"0,29,27:3,3,1,27:8,2,27:12,29:4,27,29,24,23,17,21,14,22,27:2,12,27:2,13,27," +
"20,18,16,27:2,25,11,19,27:3,15,27,7,29,8,29:2,0:2")[0];
	...
	return new Symbol(sym.EOF);
			...
			return new Symbol(sym.VAR, yytext());
					...
					case -13:
						break;
					case 13:
						{ // END on a line by itself is EOF
			  return new Symbol(sym.EOF);}
					case -14:
						break;
					case 14:
